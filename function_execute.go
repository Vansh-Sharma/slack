...
// FunctionCompleteSuccessContext indicates function is completed with context
...
// FunctionCompleteErrorContext indicates function is completed with error with context
